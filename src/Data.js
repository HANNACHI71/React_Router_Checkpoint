export const Data = [
    {
        ...
        rate: 4,
        description:
            "Theodore is a lonely man in the final stages of his divorce. When he's not working as a letter writer, his down time is spent playing video games and occasionally hanging out with friends. He decides to purchase",
        posterUrl: "../images/Her.jpg",
    ...
    },
    {
        ...
        rate: 5,
        description:
            "A Polish Jewish musician struggles to survive the destruction of the Warsaw ghetto of World War II.In this memoir, Wiesel uses complex figurative language such as similes and metaphors to display the theme.",
        posterUrl:
    ...
    },
    {
        ...
        rate: 4,
        description:
            "Haunted and gaunt after a prolonged bout of insomnia, factory worker Trevor Reznik begins to question his sanity amid a series of mysterious events. Watch all you want. Christian Bale.",
        posterUrl:
    ...
    },
    {
        ...
        rate: 3,
        description:
            "Greed and class discrimination threaten the newly formed symbiotic relationship between the wealthy Park family and the destitute Kim clan.One by one, the crafty members of",
        posterUrl:
